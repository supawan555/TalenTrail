...
// กำหนด Props ทั้งหมดที่หน้า UI ต้องการ
export interface SettingsUIProps {
  ...
  // Submit Handlers
  onProfileSubmit: SubmitHandler<ProfileFormData>;
  onPasswordSubmit: SubmitHandler<PasswordFormData>;
}
            ...
            <div className="space-y-4">
              ...
              {logout && (
                <div className="flex items-center justify-between p-4 border border-red-100 bg-red-50 rounded-lg">
                  <div>
                    <h4 className="text-red-900 font-medium">Sign Out</h4>
